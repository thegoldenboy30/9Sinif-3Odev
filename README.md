...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (hiç değilse birkaç frame benim ölçümlerinden farklı olsun.) Kullandığınız Google Sheet için [buraya](https://docs.google.com/spreadsheets/d/1-4CO4daIRGWo-6HYOtZlHtaWhEPYr2xoe6ZyLxlCFmU/edit) link verin (Google Sheet herkese açık erişimli olsun.) 

a) Denkleminizi **bilgisayardan polinom şeklinde yapıp denklenimini bulacaktım, bilgisayarm bozuldu ve mobilden yapamadım.. Bu yüzden sonraki sorularla ilgili de fikrim yok.**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? Sizce niçin a'nın değeri negatif? 
